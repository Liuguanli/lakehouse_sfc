...
# ---------------------------------------------------------------------------
# Scenarios (Iceberg, Amazon) – mirror RQ1 Amazon scenarios; layouts baseline/linear/zorder.
...
declare -A SCENARIO_AMAZON_DEFAULT=(
  ...
  [output_root]="workloads/amazon_rq5_iceberg/amazon_default"
  [dataset_name]="amazon"
)
...
declare -A SCENARIO_AMAZON_DEFAULT_V1=(
  ...
  [target_mb]="128"
  [query_args]="--workload-type custom --spec-dir workload_spec/amazon_rq1 --spec-glob spec_amazon_RQ1_*_C1.yaml"
  [output_root]="workloads/amazon_rq5_iceberg/amazon_default_v1"
  [dataset_name]="amazon"
)
...
declare -A SCENARIO_AMAZON_O2_V1=(
  ...
  [target_mb]="128"
  [query_args]="--workload-type custom --spec-dir workload_spec/amazon_rq1 --spec-glob spec_amazon_RQ1_*_C1.yaml"
  [output_root]="workloads/amazon_rq5_iceberg/amazon_sort_variant_o2_v1"
  [dataset_name]="amazon"
)
...
declare -A SCENARIO_AMAZON_O2_V2=(
  ...
  [target_mb]="128"
  [query_args]="--workload-type custom --spec-dir workload_spec/amazon_rq1 --spec-glob spec_amazon_RQ1_*_C1.yaml"
  [output_root]="workloads/amazon_rq5_iceberg/amazon_sort_variant_o2_v2"
  [dataset_name]="amazon"
)
...
declare -A SCENARIO_AMAZON_O3_V1=(
  ...
  [target_mb]="128"
  [query_args]="--workload-type custom --spec-dir workload_spec/amazon_rq1 --spec-glob spec_amazon_RQ1_*_C1.yaml"
  [output_root]="workloads/amazon_rq5_iceberg/amazon_sort_variant_o3_v1"
  [dataset_name]="amazon"
)
...
declare -A SCENARIO_AMAZON_O3_V2=(
  ...
  [target_mb]="128"
  [query_args]="--workload-type custom --spec-dir workload_spec/amazon_rq1 --spec-glob spec_amazon_RQ1_*_C1.yaml"
  [output_root]="workloads/amazon_rq5_iceberg/amazon_sort_variant_o3_v2"
  [dataset_name]="amazon"
)
